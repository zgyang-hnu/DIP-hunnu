...
def make_dilatedlayers(cfg, batch_norm=False):
    layers = []
    in_channels = 3
    i =0
    for v in cfg:
...
cfg = {
    ...
    'D8': [64, 64, 'M', 128, 128, 'M', 256, 256, 256, 'M', 512, 512, 512,  512, 512, 512],
...
def vgg16(pretrained=False, **kwargs):
    ...
    if pretrained:
        kwargs['init_weights'] = False
    model = VGG(make_dilatedlayers(cfg['D8']), **kwargs)
    if pretrained:
        #model.load_state_dict(model_zoo.load_url(model_urls['vgg16']))
        model_path = './initmodel/vgg16-397923af.pth'
